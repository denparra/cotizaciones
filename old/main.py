...
html_mensaje = f"""
<div style="border:1px solid #ddd; padding:10px; background-color:#3a1919; font-family: monospace; margin-top:10px; overflow: auto;">
  <h4 style="margin-bottom:5px; color: white;">Mensaje Generado</h4>
  <pre id="mensaje" style="white-space: pre-wrap; word-wrap: break-word; color: white;">{mensaje}</pre>
  ...
  }})()" style="margin-top:10px; width:100%; position: relative; z-index: 999;">Copiar mensaje</button>
</div>
"""
with st.sidebar:
    components.html(html_mensaje, height=300)
