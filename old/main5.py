...
if opcion == "Inicio":
    ...
    # Pesos relativos para columnas: [Fecha, Última vez, Visita, Nombre, Teléfono, Auto, Enviar, Link Auto, ID]
    ...
    for index, row in df_paginated.iterrows():
        ...
        # Botón "Enviar" que realiza:
        # 1. Actualiza el mensaje en el área de texto.
        # 2. Copia el mensaje al portapapeles.
        # 3. Abre la URL de WhatsApp en una nueva pestaña.
